...
Der Stationärefall tritt etwa bei $T = 24min$ ein. Das Einen stationäre Temperaturdiffernez von:
\begin{equation}
...
\begin{equation}
\lambda_{\mathrm{Cu}} = 372.55 \pm 62.63 \,\frac{\mathrm{W}}{\mathrm{m\,K}}
\end{equation}

\begin{equation}
\lambda_{\mathrm{Al}} = 188.50 \pm 27.84 \,\frac{\mathrm{W}}{\mathrm{m\,K}}
\end{equation}

Die Literaturwerte betragen  
$\lambda_{\mathrm{Cu,\,Lit}} = 401\,\mathrm{W/(m\,K)}$ und  
$\lambda_{\mathrm{Al,\,Lit}} = 237\,\mathrm{W/(m\,K)}$ \cite{3}.

Der Wert für Kupfer stimmt – unter Berücksichtigung der Fehlergrenzen – mit dem Literaturwert überein. Für Aluminium zeigt sich jedoch selbst innerhalb der Unsicherheiten eine deutliche Abweichung. Mögliche Ursachen hierfür werden im Folgenden diskutiert.
